...
$string['modulename_help'] = 'Use the Mobas module to author mobile activities for students. The mobas module allows students to download an activity, complete it offline, and submit back to moodle when online.';
$string['mobasfieldset'] = 'Mobas Settings';
$string['mobasname'] = 'Mobas mobile assessment';

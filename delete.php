...
$url = new moodle_url('/mod/assign/submission/mobas/delete.php');
...
$submission_plugin = $assignment->get_submission_plugin_by_type('mobas');
...
if(!$found) {
    echo $OUTPUT->header();
    echo $OUTPUT->notification(get_string('nosuchfile', 'assignsubmission_mobas'));
    ...
    if($confirm) {
        ...
        $confirmurl = new moodle_url('/mod/assign/submission/mobas/delete.php');
        ...
        echo $OUTPUT->header();
        echo $OUTPUT->confirm(get_string('confirmdeletefile', 'assignsubmission_mobas', $delpath.$delfile), $confirmurl, $viewurl);
    }
}

 ...
 * @package assignsubmission_mobas
 */
class restore_assignsubmission_mobas_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_mobas'); // we used get_recommended_name() so this works
    ...
    /**
     * Processes one assignsubmission_mobas element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_mobas_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignsubmission_mobas', $data);

        $this->add_related_files('assignsubmission_mobas', 'submissions_mobas', 'submission', null, $oldsubmissionid);
    }
